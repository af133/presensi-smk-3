...
Route::middleware(['web', 'guru'])->group(function () {
    ...
    //   Route::get('/laporan/jurnal',
    //     [JurnalReportController::class, 'index'])->name('waka.laporan.jurnal.index');
 
    // Route::post('/laporan/jurnal/preview',
    //     [JurnalReportController::class, 'preview'])->name('waka.laporan.jurnal.preview');
